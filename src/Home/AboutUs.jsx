        ...
        <div className='flex flex-col justify-evenly relative bg-slate-100 h-[100vh]'>
          ...
          <div>
            ...
            <ul className='list-inside list-disc font-thin mt-5 '>
              <li className=''>Welcome to Rising Superstar Preschool in <strong>Bhugaon!</strong></li> 
              <li>Our admissions are now open, and we can't wait to help your little one thrive.</li>
              <li>With a caring environment and convenient transport facilities, we make it easy for your child to succeed.</li>
              <li>Hurry and contact us at 7020054270 to reserve your spot today!</li>
            </ul>
          </div>
